...
object HindiStrings : Strings {
    ...
    override val messagesSent = "संदेश"
    override val messagesSimulated =
        "यह नमूना है - संदेश तैयार हुआ है, पर अभी भेजा नहीं गया।"
    override val messageReferral = "परिवार को"
    override val messageEscalation = "आपकी ANM को"
    override val messageReminder = "परिवार को याद दिलाना"
    override val messageNoPhone = "फ़ोन नंबर नहीं है - ख़ुद जाकर बताएँ"
    override fun messageHolds(date: String) = "$date को जाएगा"
