...
object EnglishStrings : Strings {
    ...
    override val messagesSent = "Messages"
    override val messagesSimulated =
        "Simulated - written and queued, but not actually delivered."
    override val messageReferral = "To the family"
    override val messageEscalation = "To your ANM"
    override val messageReminder = "Reminder to the family"
    override val messageNoPhone = "No phone number - tell them in person"
    override fun messageHolds(date: String) = "Sends on $date"
